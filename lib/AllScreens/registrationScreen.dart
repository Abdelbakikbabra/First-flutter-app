...
class RegistraionScreen extends StatelessWidget {
  ...
  TextEditingController specialityTextEditingController =
                    ...
                    RaisedButton(
                      ...
                      onPressed: () {
                        if (nameTextEditingController.text.length < 3) {
                          displayToastMessage(
                              "name must be atleast 3 chars", context);
                        ...
                        } else if (specialityTextEditingController
                            .text.isEmpty) {
                          displayToastMessage(
                              "please fill the speciality text", context);
